...
resource "aws_vpc_endpoint" "s3VPCEndpoint" {
  ...
  route_table_ids = [ aws_route_table.RouteTablePublic.id,aws_route_table.RouteTablePrivate1.id,aws_route_table.RouteTablePrivate2.id,aws_route_table.RouteTablePrivate3.id ]
  policy = <<POLICY
{
  "Version": "2012-10-17",
  "Statement": [
