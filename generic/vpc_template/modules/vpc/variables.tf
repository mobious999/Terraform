...
#   description = "List of security group IDs to associate with VPC endpoints"
#   type        = list(string)
#   default     = []
# }

# variable "vpc_endpoint_sg_ids" {
#   description = "List of existing Security Group IDs to associate with VPC endpoints. Required if create_security_groups=false."
#   type        = list(string)
#   default     = []
# }
